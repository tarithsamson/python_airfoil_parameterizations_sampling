...
# func = lambda x: np.linalg.norm(PARSEC(X0,N,xdist) - airfoil)
# bounds = [
#         (1e-4, 0.5), # x coord of maximum z coord of the upper surface
#         (-0.1, 0.0), #  maximum z coord of the upper surface
#         (-0.5, 0.5), # curvature of upper surface at maximum z-coord
#         (0.001, 0.1), # LE radius of the upper surface
#         (1e-4, 0.5), # x coord of maximum z coord of the upper surface
#         (-0.1, 0.0), # maximum z coord of the lower surface
#         (-0.5, 0.5), # curvature of lower surface at minimum z-coord
#         (0.001, 0.1), # LE radius of the lower surface
#         (-0.1745, 0.1745), # TE angle
#         (-0.1745, 0.1745)] # TE wedge angle
